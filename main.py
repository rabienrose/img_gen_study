...
train_set = MNIST(root=data_root, download=True, train=True, transform=transform)
...
test_set = MNIST(root=data_root, download=True, train=False, transform=transform)
